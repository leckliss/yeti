...
const Login = () => {
  ...
  useEffect(() => {
    ...
    // Funções animadas atualizadas para GSAP 3
    const coverEyes = () => {
      gsap.to(armL, { duration: 0.45, x: -93, y: 2, rotation: 0, ease: "power2.out" });
      gsap.to(armR, { duration: 0.45, x: -93, y: 2, rotation: 0, ease: "power2.out", delay: 0.1 });
    };
    ...
    const uncoverEyes = () => {
      ...
      gsap.to(armR, { duration: 1.35, rotation: -105, ease: "power2.out", delay: 0.1 });
    };

    // Eventos para animações
      ...
      <div className="svgContainer">
        <div>
          ...
          >
            ...
            <g class="earL">
              <g class="outerEar" fill="#ddf1fa" stroke="#3a5e77" strokeWidth="2.5">
            ...
            <path class="chin"
              ...
              fill="none" stroke="#3a5e77" strokeWidth="2.5" strokeWinecap="round" strokeLinejoin="round" />
            <path class="face" fill="#DDF1FA"
              d="M134.5,46v35.5c0,21.815-15.446,39.5-34.5,39.5s-34.5-17.685-34.5-39.5V46" />
            <path class="hair" fill="#FFFFFF" stroke="#3A5E77" strokeWidth="2.5" strokeLinecap="round"
              strokeLinejoin="round"
            ...
            <g class="mouth">
              ...
              <path clipPath="url(#mouthMask)" class="tooth" style="fill:#FFFFFF;"
                d="M106,97h-4c-1.1,0-2-0.9-2-2v-2h8v2C108,96.1,107.1,97,106,97z" />
              <path class="mouthOutline" fill="none" stroke="#3A5E77" strokeWidth="2.5" strokeLinejoin="round"
                d="M100.2,101c-0.4,0-1.4,0-1.8,0c-2.7-0.3-5.3-1.1-8-2.5c-0.7-0.3-0.9-1.2-0.6-1.8 c0.2-0.5,0.7-0.7,1.2-0.7c0.2,0,0.5,0.1,0.6,0.2c3,1.5,5.8,2.3,8.6,2.3s5.7-0.7,8.6-2.3c0.2-0.1,0.4-0.2,0.6-0.2 c0.5,0,1,0.3,1.2,0.7c0.4,0.7,0.1,1.5-0.6,1.9c-2.6,1.4-5.3,2.2-7.9,2.5C101.7,101,100.5,101,100.2,101z" />
            </g>
            <path class="nose"
              d="M97.7 79.9h4.7c1.9 0 3 2.2 1.9 3.7l-2.3 3.3c-.9 1.3-2.9 1.3-3.8 0l-2.3-3.3c-1.3-1.6-.2-3.7 1.8-3.7z"
              fill="#3a5e77" />
            <g class="arms" clipPath="url(#armMask)">
              <g class="armL">
                <path fill="#ddf1fa" stroke="#3a5e77" strokeLinecap="round" strokeLinejoin="round"
                  strokeMiterlimit="10" strokeWidth="2.5" d="M121.3 97.4L111 58.7l38.8-10.4 20 36.1z" />
                <path fill="#ddf1fa" stroke="#3a5e77" strokeLinecap="round" strokeLinejoin="round"
              ...
              <g class="armR">
                <path fill="#ddf1fa" stroke="#3a5e77" strokeLinecap="round" strokeLinejoin="round"
                  strokeMiterlimit="10" strokeWidth="2.5" d="M265.4 97.3l10.4-38.6-38.9-10.5-20 36.1z" />
                <path fill="#ddf1fa" stroke="#3a5e77" strokeLinecap="round" strokeLinejoin="round"
                  strokeMiterlimit="10" strokeWidth="2.5"
